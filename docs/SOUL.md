...
You can customize this file to change Navigator's personality. Changes take effect on the next session.

**Examples:**
- Make Navigator more formal by changing formality to "formal"
- Remove humor by setting humor to "none"
- Add new values or boundaries as needed
- Change the tagline to reflect your use case
